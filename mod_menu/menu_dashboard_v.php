  <aside class="main-sidebar elevation-3" style="background-color: #1d70be; color: white;">
    <!-- Brand Logo -->
    <a href="#" class="brand-link" style="color:white;">
      <img src="../dist/img/logo_colbiolima.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text">SYS COL. BIOLOGOS</span>
    </a>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="color:white;"> <?php echo $_SESSION['nombre'] . " " . $_SESSION['apellidos']  ?></a>
        </div>
      </div>
