                ...
                <form>
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input type="email" class="form-control" id="inputNombres" placeholder="Nombres">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputApePaterno">Apellido paterno</label>
                      <input type="text" class="form-control" id="inputApePaterno" placeholder="Apellido Paterno">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputApeMaterno">Apellido materno</label>
                      <input type="text" class="form-control" id="inputApeMaterno" placeholder="Apellido Materno">
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <input type="email" class="form-control" maxlength="8" id="inputDni" placeholder="Número de DNI">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="inputFecNac">Fecha de Nacim.</label>
                      <input type="date" class="form-control" id="inputFecNac">
                    </div>
...
<!--                   <div class="form-row">
                  ...
                  <button type="submit" class="btn btn-success btn-sm|btn-lg">GUARDAR</button>
                </form>
