...
if (1==1)
{
  ...
  $sql = "SELECT CE.idCertificado, 
          ...
          WHERE CE.estadoCertificado = 1 AND CE.idCertificado = " . $_GET['id'] . " AND CO.idColegiado = " . $_GET['idColegiado'] . "
...
$logo = ENLACE_WEB . "mod_usuarios/certificado.jpg";
...
//                   "Email : ".$email, $logo, $ext_logo);
  ...
  $fechaCol = $dia . " DE " . $mes . " DE " . $anio; 
      ...
      $sql3 = "SELECT `idPagoServ`, `fecha_pago_serv`, `idColegiado`, `monto`, `estado` 
               ...
               WHERE `idColegiado` = " . $_GET['idColegiado'] . " ORDER BY 1 DESC LIMIT 0,1";
      $db = $dbh->prepare($sql3);
      $db->execute();
